...
if __name__ == "__main__":
    ...
    # print(toy_sample)
    toy_data = PyGToyDataset(save_root="D:/material_project/cif_to_graph/gcn_data")  # 100个样本（图）
    # print(toy_data[0])
    data_loader = DataLoader(toy_data, batch_size=1, shuffle=True) # batch_size=5实现了平行化——就是把5张图放一起了
